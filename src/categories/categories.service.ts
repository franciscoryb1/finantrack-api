...
export class CategoriesService {
  ...
  /**
   * Lista plana de categorías EXPENSE (propias + globales) para que n8n mapee
   * el nombre del comercio a un categoryId antes de ingestar un consumo.
   */
  async listForIngestion(userId: number) {
    ...
    if (parentId) {
      ...
      if (!parent) {
        throw new BadRequestException(
          'Parent category not found or not accessible',
        );
      }
